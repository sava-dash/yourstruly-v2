...
const tabs = [
  ...
  { href: '/dashboard/memories', icon: BookOpen, label: 'My Story' },
          ...
          if (fab) {
            return (
              <Link
                ...
                aria-label={label}
              >
                <span className="flex items-center justify-center w-14 h-14 rounded-full bg-amber-700 shadow-lg shadow-amber-900/40">
                  <Icon size={24} className="text-white" />
                </span>
                <span className="text-[10px] mt-1 text-amber-500">{label}</span>
              </Link>
            )
          }
