    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-5">
          {/* Quick Create */}
          {showCreate ? (
            <div className="mb-4 p-4 bg-[#2D5A3D]/5 rounded-xl">
              <input
                type="text"
                value={newName}
                onChange={e => setNewName(e.target.value)}
                placeholder="New album name..."
                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-[#2D5A3D] focus:ring-2 focus:ring-[#2D5A3D]/20 outline-none transition-all mb-3"
                autoFocus
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-[#2D5A3D] hover:bg-[#234A31] text-white rounded-xl font-medium transition-colors disabled:opacity-50"
                >
            ...
            <button
              ...
              className="w-full mb-4 p-4 border-2 border-dashed border-gray-300 rounded-xl text-gray-500 hover:border-[#2D5A3D] hover:text-[#2D5A3D] transition-colors flex items-center justify-center gap-2"
            >
              <Plus size={18} />
              Create New Album
            </button>
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`w-6 h-6 rounded-full flex items-center justify-center transition-colors ${
                      album.has_memory ? 'bg-[#2D5A3D] text-white' : 'border-2 border-gray-300'
                    }`}>
                      {isSaving ? (
        ...
        {/* Footer */}
        <div className="p-4 border-t border-[#2D5A3D]/10">
          <button
            onClick={onClose}
