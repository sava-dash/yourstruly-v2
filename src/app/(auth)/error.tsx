  ...
  return (
    <div className="min-h-screen bg-[#FAFAF7] flex items-center justify-center p-8">
      <div className="text-center max-w-md">
        <h1 className="text-xl font-semibold text-[#1A1F1C] mb-2">Authentication Error</h1>
        <p className="text-[#5A6660] mb-6">Something went wrong. Please try signing in again.</p>
