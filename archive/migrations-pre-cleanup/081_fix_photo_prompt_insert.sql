-- Migration 081: Fix photo prompt generation
-- Issue: generate_engagement_prompts photo loop not inserting despite correct logic
-- Fix: Use explicit exception handling instead of ON CONFLICT DO NOTHING
...
COMMENT ON FUNCTION generate_engagement_prompts IS 'Generate personalized prompts with photo support. Uses exception handling for duplicate detection.';
