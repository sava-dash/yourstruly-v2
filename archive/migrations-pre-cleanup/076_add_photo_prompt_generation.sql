-- Migration 076: Add photo prompt generation to engagement function
-- This updates generate_engagement_prompts to create photo_backstory prompts

-- Update the function to include photo prompts
...
-- Clear pending prompts to regenerate with photos
DELETE FROM engagement_prompts WHERE status = 'pending';

COMMENT ON FUNCTION generate_engagement_prompts IS 'Generate personalized prompts including photo backstory, contact stories, and profile-based questions';
