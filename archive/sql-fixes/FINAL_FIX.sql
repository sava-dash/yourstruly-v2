-- ============================================================================
-- FINAL FIX: Reset shuffle function to pick up new schema
-- This fixes the "column count mismatch" error
-- ============================================================================

-- Step 1: Check current schema
SELECT column_name, ordinal_position, data_type 
FROM information_schema.columns 
WHERE table_name = 'engagement_prompts' 
ORDER BY ordinal_position;

-- Step 2: Drop ALL functions that return engagement_prompts
-- (This forces PostgreSQL to forget the cached schema)
DROP FUNCTION IF EXISTS shuffle_engagement_prompts(UUID, INTEGER, BOOLEAN) CASCADE;
DROP FUNCTION IF EXISTS generate_engagement_prompts(UUID, INTEGER) CASCADE;

-- Step 3: Recreate shuffle_engagement_prompts
...
-- Verify
SELECT 'Shuffle function recreated with explicit column list!' as status;
