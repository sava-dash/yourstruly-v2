-- Migration 083: Fix photo loop - remove exception handling that may be interfering
-- The debug function works without exception handling, so let's match that
...
BEGIN
  ...
  -- PHOTO PROMPTS (no exception handler - matches working debug function)
  FOR v_photo IN 
